            ...
            <main className="flex-1 p-6 overflow-auto">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-4xl font-black mb-3">📚 מילון טיפוסי נתונים</h1>
                        <p className="text-text-muted text-lg">כל מה שצריך לדעת על טיפוסי נתונים בפייתון</p>
                    </div>
                    ...
                    <section className="mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {dataTypes.map((dt) => (
                                <div
                                    key={dt.name}
                                    className="bg-surface-dark rounded-xl border border-border-dark p-5 hover:border-primary/50 transition-all"
                                >
                                    <div className="flex items-center justify-between mb-3">
                                        <h3 className="text-xl font-bold text-primary">{dt.name}</h3>
